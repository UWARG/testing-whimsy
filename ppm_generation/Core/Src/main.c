...
/* USER CODE BEGIN PV */
uint32_t ccr_value, arr_value,arr_time;
float channel_percentage_value[channel_reserved] = {HIGH_PERC,MID_PERC,LOW_PERC,HIGH_PERC,MID_PERC,LOW_PERC,HIGH_PERC,MID_PERC,LOW_PERC,HIGH_PERC,HIGH_PERC};
uint8_t counter =0;
